...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "De R$20k a R$200k — Webinar Gratuito 05/06" },
      { name: "description", content: "Webinar exclusivo: o método comercial que ninguém te contou. 05 de Junho, 20h. Vagas limitadas." },
      { property: "og:title", content: "De R$20k a R$200k — Webinar Gratuito" },
      { property: "og:description", content: "O método comercial que ninguém te contou. 05/06 · 20h · Online" },
    ],
  }),
  component: Landing,
});
  ...
  return (
    <div className="relative mx-auto min-h-screen w-full max-w-[480px] bg-background pb-24 text-foreground">
      ...
      <div className="sticky top-0 z-50 w-full bg-brand px-3 py-2 text-center font-condensed text-[12px] font-semibold uppercase tracking-wider text-white">
        ...
        Evento Gratuito · Online · 05/06 · Quinta · 20h · Vagas Limitadas
      </div>
      ...
      <section className="px-5 pt-7">
        ...
        <div className="mt-3 flex flex-wrap justify-center gap-2">
          {[
            { text: "05 de Junho", indicator: "date" as const },
            { text: "20h", indicator: "pulse" as const },
